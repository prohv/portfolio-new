...
const FileTextIcon = (props: React.SVGProps<SVGSVGElement>) => (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><line x1="10" y1="9" x2="8" y2="9"></line></svg>);
...
export function HeroSection() {
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-16 px-6 md:px-10 lg:px-16 pt-4 lg:pt-8 max-w-[1200px] mx-auto w-full">
      ...
      <div className="order-1 md:order-2 flex flex-col justify-center animate-fade-up [animation-delay:400ms] opacity-0 [animation-fill-mode:forwards] group">
        {/* Wrapper tied exactly to the profile picture's dimensions */}
        <div className="relative w-full">
          {/* Floating Decorative Bars */}
          <div className="absolute -top-4 -right-4 w-8 h-20 md:w-12 md:h-32 bg-amber rounded-[24px] border-4 border-cream z-10 transition-transform duration-500 group-hover:translate-y-2 group-hover:-translate-x-2 group-hover:scale-88" />
          <div className="absolute -bottom-4 -left-4 w-8 h-20 md:w-12 md:h-32 bg-amber rounded-[24px] z-10 border-4 border-cream transition-transform duration-500 group-hover:-translate-y-2 group-hover:translate-x-2 group-hover:scale-88" />
